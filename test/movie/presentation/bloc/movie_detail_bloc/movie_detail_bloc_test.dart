...
import 'package:ditonton_revamp/feature/movie/domain/usecases/get_movie_recommendations.dart';
import 'package:ditonton_revamp/feature/movie/presentation/movie_detail_bloc/movie_detail_bloc.dart';
import 'package:ditonton_revamp/feature/movie/presentation/movie_detail_bloc/movie_detail_event.dart';
import 'package:ditonton_revamp/feature/movie/presentation/movie_detail_bloc/movie_detail_state.dart';
...
void main() {
  ...
  blocTest<MovieDetailBloc, MovieDetailState>(
    ...
    build: () {
      when(
        mockGetMovieDetaill.execute(tId),
